...
function ProductsPage() {
    ...
    return (
        <section>
            ...
            {isPending && (
                <p className="mt-6">Cargando productos, categorias y unidades...</p>
            )}

            {isError && (
                <p className="mt-6 text-destructive">
                    No se pudieron cargar los datos necesarios para administrar productos.
                </p>
            )}
            ...
            {!isPending && !isError && (
                <>
                    <p className="mt-2 text-sm text-muted-foreground">
                        Categorias disponibles: {categories.length}
                    </p>
